...
public class BleAdvertisementContent {
    ...
    private final HashMap<BleUtils.AD_TYPE, byte[]> advertisementData = new HashMap<>(); // current
    private final HashMap<BleUtils.AD_TYPE, byte[]> advertisementDataAll = new HashMap<>(); // current + "history"
    private String name = "";
