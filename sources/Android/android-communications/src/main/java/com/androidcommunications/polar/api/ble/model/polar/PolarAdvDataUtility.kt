...
import com.androidcommunications.polar.api.ble.model.advertisement.BleAdvertisementContent.BLE_ADV_POLAR_PREFIX_IN_LOCAL_NAME
...
object PolarAdvDataUtility {
    ...
    fun isPolarDevice(name: String): Boolean {
        return name.trim().startsWith(BLE_ADV_POLAR_PREFIX_IN_LOCAL_NAME) && name.trim().split(" ").size > 2
    }
}