...
import com.androidcommunications.polar.api.ble.model.gatt.client.BlePMDClient.EcgData
...
class BlePmdClientEcgTest {
    ...
    fun test_Ecg_DataSample_type0() {
        ...
        // Act
        val ecgData = EcgData(type, measurementFrame, timeStamp)
    ...
    fun test_Ecg_DataSample_type1() {
        ...
        Assert.assertEquals(contactImpedance1.toLong(), ecgData.ecgSamples[0].contactImpedance.toLong())
        ...
        Assert.assertEquals(contactImpedance2.toLong(), ecgData.ecgSamples[1].contactImpedance.toLong())
        Assert.assertEquals(ecgValue2.toLong(), ecgData.ecgSamples[1].microVolts.toLong())
        Assert.assertEquals(2, ecgData.ecgSamples.size.toLong())
    }
