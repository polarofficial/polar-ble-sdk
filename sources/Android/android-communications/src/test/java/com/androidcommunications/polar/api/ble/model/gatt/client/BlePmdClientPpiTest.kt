...
import com.androidcommunications.polar.api.ble.model.gatt.client.BlePMDClient.PpiData
...
class BlePmdClientPpiTest {
    ...
    fun test_PPI_DataSample() {
        ...
        val measurementFrame = byteArrayOf(0x80.toByte(), 0x80.toByte(), 0x80.toByte(), 0x80.toByte(), 0x80.toByte(), 0xFF.toByte(), 0x00.toByte(), 0x01.toByte(), 0x00.toByte(), 0x01.toByte(), 0x00.toByte(), 0x00.toByte())
        val timeStamp: Long = Long.MAX_VALUE

        // Act
        val ppiData = PpiData(measurementFrame, timeStamp)
