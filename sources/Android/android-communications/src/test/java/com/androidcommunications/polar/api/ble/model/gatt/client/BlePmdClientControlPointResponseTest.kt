...
class BlePmdClientControlPointResponseTest {
    ...
    fun `success control point response for acc stream settings`() {
        ...
        val expectedStatus = BlePMDClient.PmdControlPointResponse.PmdControlPointResponseCode.SUCCESS
        ...
        val cpResponse = byteArrayOf(0xF0.toByte(), 0x01.toByte(), 0x02.toByte(), 0x00.toByte(), 0x00.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte())
    ...
    fun `failing control point response for mag stream settings`() {
        ...
        val expectedStatus = BlePMDClient.PmdControlPointResponse.PmdControlPointResponseCode.ERROR_INVALID_RESOLUTION
        // 4:       More                                   size 1:     0x00 (No more)
        val expectedMore = false
        // 5..n:    Parameters                             size 3:     0xFF 0xFF 0xFF (some data)
        ...
        val cpResponse = byteArrayOf(0xF0.toByte(), 0x01.toByte(), 0x06.toByte(), 0x07.toByte(), 0x00.toByte())
