...
class BleGattBaseTest {
    ...
    class ConcreteImplBleGattBase(txInterface: BleGattTxInterface?) : BleGattBase(txInterface, SOME_BLE_SERVICE_UUID) {
    ...
    fun `add notification characteristic`() {
        //Arrange
        val someBleCharacteristicsUUID: UUID = UUID.fromString("ffffffff-1234-1234-1234-1234567890ab")
    ...
    fun `remove notification characteristic`() {
        //Arrange
        val someBleCharacteristicsToRemoveUUID: UUID = UUID.fromString("ffffffff-1234-1234-1234-1234567890ab")
        val someBleCharacteristicToKeepUUID: UUID = UUID.fromString("eeeeeeee-1234-1234-1234-1234567890ab")
        val someBleCharacteristicToRemoveWhichNotFoundUUID: UUID = UUID.fromString("bbbbbbbb-1234-1234-1234-1234567890ab")
