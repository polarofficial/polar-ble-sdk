...
class BleHrClientTest {
    ...
    fun test_EnergyExpended() {
        ...
        val measurementFrame1 = byteArrayOf(0x09.toByte(), 0x00.toByte(), 0x00.toByte(), 0xFF.toByte(), 0xFF.toByte())
        // HEX: 08 00 7F 80
        // index    type                                                data:
    ...
    fun test_RRinterval() {
        ...
        val measurementFrame1 = byteArrayOf(0x10.toByte(), 0x00.toByte(), 0xFF.toByte(), 0xFF.toByte())
