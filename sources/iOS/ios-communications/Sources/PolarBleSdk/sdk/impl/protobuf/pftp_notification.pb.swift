...
public enum Protocol_PbPFtpDevToHostNotification: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum Protocol_Action: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case created // = 0
  case updated // = 1
  case removed // = 2
...
public enum Protocol_PbPFtpSyncTriggerSource: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case noSource // = 0
  case user // = 1
  case timed // = 2
...
public enum Protocol_PbPftpPnsDHAttributeType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Protocol_MediaControlRequest: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Protocol_MediaControlCommand: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case play // = 1
  case pause // = 2
...
/// data (SAGRFC56) and defined below, individually per notification type.
public enum Protocol_PbPFtpHostToDevNotification: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Protocol_PbPftpPnsHDCategoryID: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Protocol_PbPftpPnsHDAttributeType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case title // = 0
  case subtitle // = 1
  case message // = 2
...
public enum Protocol_PlaybackState: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case stateNone // = 1
  case stateStopped // = 2
  case statePlaying // = 3
...
public struct Protocol_PbPFtpFilesystemModifiedParams: Sendable {
...
public struct Protocol_PbPFtpInactivityAlert: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpTrainingSessionStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpAutoSyncStatusParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpSyncTrigger: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasFeatureName: Bool {return self._featureName != nil}
...
public struct Protocol_PbPFtpSyncRequiredParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpPolarShellMessageParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpPnsDHAttribute: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpPnsDHNotificationResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpPnsState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpStartGPSMeasurement: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpDHMediaControlRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpDHMediaControlCommand: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpDHMediaControlEnabled: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpDHRestApiEvent: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasUncompressed: Bool {return self._uncompressed != nil}
...
public struct Protocol_PbInitializeSessionParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbFirmwareUpdateAvailableParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpSimulateButtonPressParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpTouchPosition: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpSimulateTouchScreenParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum PbPFtpTouchState: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
...
public struct Protocol_PbPFtpStopSyncParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpFactoryResetParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasHibernate: Bool {return self._hibernate != nil}
...
public struct Protocol_PbPFtpStartAutosyncParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpPnsHDAttribute: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPftpPnsHDNotification: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Protocol_PbPFtpGPSDataParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasHorizontalAccuracy: Bool {return self._horizontalAccuracy != nil}
  /// Clears the value of `horizontalAccuracy`. Subsequent reads from it will return its default value.
  public mutating func clearHorizontalAccuracy() {self._horizontalAccuracy = nil}
...
public struct Protocol_PbPFtpHDMediaData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Available commands
  public var commands: [Protocol_MediaControlCommand] = []
  ...
  public var hasPlayerName: Bool {return self._playerName != nil}
  /// Clears the value of `playerName`. Subsequent reads from it will return its default value.
  public mutating func clearPlayerName() {self._playerName = nil}
  ...
  public var hasArtistName: Bool {return self._artistName != nil}
  /// Clears the value of `artistName`. Subsequent reads from it will return its default value.
  public mutating func clearArtistName() {self._artistName = nil}
...
public struct Protocol_PbPFtpHDMediaControlPlaybackState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Current playback state of media
  public var playbackState: Protocol_PlaybackState {
...
extension Protocol_PbPFtpHDMediaData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPFtpHDMediaData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Protocol_PbPFtpHDMediaData, rhs: Protocol_PbPFtpHDMediaData) -> Bool {
...
extension Protocol_PbPFtpHDMediaControlPlaybackState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPFtpHDMediaControlPlaybackState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Protocol_PbPFtpHDMediaControlPlaybackState, rhs: Protocol_PbPFtpHDMediaControlPlaybackState) -> Bool {
